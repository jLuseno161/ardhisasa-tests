describe('Extension of User Process', { testIsolation: false }, () => {
    before(() => {
    ...
    it('should navigate to Extension of User Applications', () => {
        ...
        cy.contains('Extension of User').should('be.visible').click();
    })

    it('should verify page and initiate new application ', () => {
        cy.url().should('include', '/user/MoLPP/land-admin/development-control/processes/EXTENSION%20OF%20USER');
        cy.contains('Extension Of User Applications').should('exist')
