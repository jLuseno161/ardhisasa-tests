describe('Extension of Lease Process', { testIsolation: false }, () => {
    before(() => {
    ...
    it('should navigate to Extension of User Applications', () => {
        ...
        cy.contains('Extension of Lease').should('be.visible').click();
    })

    it('should verify page and initiate new application ', () => {
        cy.url().should('include', '/user/MoLPP/land-admin/development-control/processes/EXTENSION%20OF%20LEASE');
        cy.contains('Extension Of Lease Applications').should('exist')
    ...
    it('should navigate to application details tab and fill application data', () => {
        ...
        cy.get('.mat-option')
            .contains('Extension Of Lease')
            .should('be.visible')
            .click();

        // cy.get('[formcontrolname="parcel_number"]').type('NAIROBI/BLOCK111/1079')
        cy.get('[formcontrolname="parcel_number"]').type('NAIROBI/BLOCK82/1224')
